...
function leftClick(id, text, record, currentNode) {
	var url = Global.contextPath + '/modules/sms/sms_send_log.jsp';
...
function doOnLoaded() {
    if (document.getElementById("content_frame").src == "") {
        var url = Global.contextPath + '/modules/sms/sms_send_log.jsp?categoryId=&categoryName='+encodeURI(rootName);
        document.getElementById("content_frame").src = url;
    }
}
