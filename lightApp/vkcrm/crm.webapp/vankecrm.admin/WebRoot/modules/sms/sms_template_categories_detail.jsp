...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>
		   <c:choose>
				<c:when test="${empty param.categoryId}">注册短信模板分类</c:when>
				<c:otherwise>修改短信模板分类</c:otherwise>
			</c:choose>
        </title>
		<%@include file="/common/meta.jsp"%>
		<ui:combine widgets="validator,inputpro,blockui,dialog"></ui:combine>
		<ui:script src="/modules/sms/script/sms_template_categories_detail.js"></ui:script>
	</head>
	...
	<div class="apply-page">
		...
		<div class="container-fluid">
	        <form id="SMS_CATEGORIES_EDIT_FORM" action="#" data-widget="validator" class="form-horizontal" >
				<!-- panel 内容 start -->
						...
						<table class="form-table col2-fluid" >
							...
							<tbody>
							    <c:choose>
									...
									<c:otherwise>
										<input type="hidden" id="id" name="id" value="${param.categoryId}"/>
								...
								<tr>
									<th>分类名称：</th>
									<td colspan="3" >
										<input type="text" id="typeName"  maxlength="75" data-validator="required,length[0,20]" 
										style="width:97%;" class="input-large" value="${smsTemplateCategories.typeName}"/>
									</td>
								</tr>
							</tbody>
						</table>							
