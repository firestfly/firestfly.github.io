...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<ui:script src="modules/sms/script/sms_send_single.js"></ui:script>
						...
						<table class="form-table col2-fluid" >
							<tbody>
								<tr>
									<th>发送号码：</th>
									<td>
										<input type="text" id="numbers"  maxlength="20" data-validator="required,mobile,length[0,20]" style="width:98%;" class="input-large"/>
									</td>
								</tr>
								<tr>
									<th>模板内容：</th>
