						...
						<table class="form-table col2-fluid" >
							...
							<tbody>
							    ...
							    <tr>
									<th>所属系统：</th>
									<td>
									<select id="belongtoSysId" name="belongtoSysId" data-validator="required">
										<option value=""></option>
										<option value="1:客服中心" <c:if test="${empty param.belongtoSysId || role.belongtoSysId == 1}"> selected</c:if> >客服中心</option>
										<option value="2:呼叫中心" <c:if test="${role.belongtoSysId == 2}"> selected</c:if> >呼叫中心</option>
									</select>
									</td>
								</tr>
