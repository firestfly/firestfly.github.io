					...
					<form id="queryForm" style="margin: 0px;">
						<table>
							...
							<tr>
							    ...
							    <th>所属系统：</th>
								<td>
									<select id="BELONGTO_SYS_ID" name="BELONGTO_SYS_ID">
										<option value=""></option>
			...
			<div class="panel grid-panel">
					...
					<div class="panel-content">
						<dg:grid container="role_div" id="role_grid">
							...
							<%}%>
							<dg:column id="BELONGTO_SYS_NAME" width="20" header="所属系统" type="ro" frozen="false" align="center"></dg:column>
							<dg:column id="DESCRIPTION" width="45" header="角色描述" type="ro" frozen="false"></dg:column>
						</dg:grid>
					</div>
				</div>
			</div>
