					...
					<div class="panel-content">
						<dg:grid container="user_div" id="user_grid" loadOnFirst="false" onAfterGridScriptLoad="loadData">
							...
							<dg:operationColumn onBeforeMenuRender="doOnBeforeMenuRender">
								...
								<security:isAllow privilege="USER_MANAGE$PROJECT_ROLE">
								<dg:action label="分配项目权限" onClick="assignProject" id="assign_project" icon="/statics/images/ico_assign_auth.gif"></dg:action>
								</security:isAllow>
