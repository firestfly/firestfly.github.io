...
(function($) {
    ...
    $.fn.lighttree = function(settings,itemOrItemId,level,asyn) {
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if(nd.fontColor){// 邱楚生 手机号码:15916451862,13560392970 QQ:65509713 扩展20151211 禁用显示灰色 短信模板分类使用 callcenter.sms.tree
            	ht.push("<span unselectable='on' style='color: "+nd.fontColor+"'>", nd.text, "</span>");
            }else{
