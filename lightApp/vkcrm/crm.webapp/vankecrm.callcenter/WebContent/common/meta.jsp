...
<link rel="stylesheet" type="text/css" href="${staticWeb}/font/cc/iconfont.css?v=${resourceVer}">
<link rel="stylesheet" type="text/css" href="${staticWeb}/css/cc/main.css?v=${resourceVer}">
