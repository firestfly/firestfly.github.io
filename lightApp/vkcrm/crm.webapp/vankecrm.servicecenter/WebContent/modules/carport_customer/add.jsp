...
<div class="wrap">
    ...
    <div class="content scrollable c_form ">
        ...
        <div id="addc-form">
            ...
            <form method="post" id="form_houseRel" style="display:none;">
                <div class="panel form-actions">
                    <div class="panel-header">
                        <div class="panel-title icf-page"> 车位关系</div>
                    </div>
            ...
            <form method="post" id="form_kehuRel" style="display:none;">
                <div class="panel form-actions">
                    <div class="panel-header">
...
<script type="text/javascript" src="${staticWeb}/js/sc/carport_customer_add.js"></script>
<script type="text/javascript">
    $(function () {
