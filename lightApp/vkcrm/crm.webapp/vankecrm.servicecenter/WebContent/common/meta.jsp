...
%>
<script src="${staticWeb}/js/config.js"></script>
<script type="text/javascript">
    ...
    var loginUser_getName = '${loginUser.getName()}';
    var loginUser_name = '${loginUser.name}';
</script>
...
<link rel="stylesheet" type="text/css" href="${staticWeb}/font/iconfont.css?v=${resourceVer}">
<link rel="stylesheet" type="text/css" href="${staticWeb}/css/sc/main.css?v=${resourceVer}">
