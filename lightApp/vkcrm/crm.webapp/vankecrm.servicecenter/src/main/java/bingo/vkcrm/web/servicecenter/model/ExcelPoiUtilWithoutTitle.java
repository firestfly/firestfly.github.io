...
public class ExcelPoiUtilWithoutTitle {
		 ...
		 * @throws Exception
		 */
		public static void createExcel2FilePath(String sheetName,String filePath, String[] headers,
				List<?> dataList) throws Exception {
		
			ExcelPoiUtilWithoutTitle poiExcelUtil = new ExcelPoiUtilWithoutTitle();
			// 1.创建 Workbook
			...
			// 3.写入 head
			poiExcelUtil.writeHeader(hssfWorkbook, hssfSheet, headers);
			// 4.写入内容
