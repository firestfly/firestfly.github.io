define([], function() {
    ...
    var noticedetail = avalon.define({
        ...
        getNoticeInfobyId: function() {
            Common.ajax({
                url: '/s.task/api/v1/notice/querynotice',
                type: "GET",
                data: {
        ...
        update: function(e) {
            if (checkForm()) {
                Common.ajax({
                    url: '/s.task/api/v1/notice/update',
                    type: "POST",
                    data: {
    ...
    function getNoticeStatus() {
        Common.ajax({
            url: servicePath.task + '/v1/dict/NoticeStatus/items',
            type: "GET",
            data: {},
            success: function(data) {
        ...
        Common.ajax({
            url: servicePath.task + '/v1/dict/ProjectNoticeLevel/items',
            type: "GET",
            data: {},
            success: function(data) {
