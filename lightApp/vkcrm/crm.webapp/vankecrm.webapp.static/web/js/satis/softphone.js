window.SoftPhone = (function() {
    ...
    */
    ...
    var initObjectX = function(prop) {
        ...
        objectX.EnableWebServiceRequest = true; //是否连接cm service --------------------------
        objectX.WebServiceIPAddr = "10.0.72.35"; //129.1.202.3
        objectX.WebServicePort = 8080;
        objectX.WebServiceMethodName = "s.tel/services/telCallWebService/receive";

        //发送坐席状态信息至CM SERVICE
        objectX.WebServiceApiAgentStatusChg = "exec=true&methodName=agentStatus&callBack=0&execType=0&methodType=set&agentID=[AgentId]&agentStat=[AgentStation]&agentType=[AgentType]&iPAddress=[IPAddr]&status=[AgentCallStatus]&callID=[CallId]&otherDN=[OtherDN]&callInType=[CallInType]&stateTime=[StateTime]";
        //软电话心跳
