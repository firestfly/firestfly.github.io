 ...
 *
 * Modules: grid.base.js; jquery.fmatter.js; grid.subgrid.js; grid.grouping.js; grid.treegrid.js; grid.pivot.js;
 */
!function (a) {
    "use strict";
    "function" == typeof
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                var
                    w, x = ["shiftKey", "altKey", "ctrlKey"], y = function (a, b) {
                        ...
                        if (a) {
                            ...
                            var
                                Y, Z = $.isFunction(d.p.afterInsertRow), _ = [], ab = !1, bb = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"), cb = M ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", db = J ? k(l, "multiBox", !1, "cbox") : "";
                ...
                var
                    bb, cb, db, eb, fb, gb, hb, ib, jb = "<thead><tr class='ui-jqgrid-labels' role='row'>", kb = "", lb = "", mb = "";
                ...
                var
                    sb = $("tr:first", jb), tb = "<tr class='jqgfirstrow' role='row'>";
                ...
                var
                    vb = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(jb), wb = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1, xb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>");
                jb = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(xb), $(xb).append(vb), vb = null, wb && $(e.hDiv).hide(), d.p.pager && ("string" == typeof
                    d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({width: e.width + "px"}).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(v), wb && $(d.p.pager).hide(), T(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function (a) {
                ...
                $(d).before(e.hDiv).click(function (a) {
                    ...
                    var
                        b = $(fb).hasClass("cbox"), c = $(d).triggerHandler("jqGridBeforeSelectRow", [gb[0].id, a]);
                ...
                var
                    Bb = q + " " + k(l, "icon_caption_open", !0), Cb = q + " " + k(l, "icon_caption_close", !0);
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function (a) {
                    ...
                    var
                        Gb = "onorientationchange"in
                            window, Hb = Gb ? "orientationchange" : "resize";
