...
import bingo.vkcrm.service.customer.v1.services.SearchService;
import bingo.vkcrm.service.customer.v1.services.SearchService.CostomerSearchType;
...
public class SearchController extends BaseController {
    ...
    public ServiceResult search(String code,String value) throws Exception {
    	...
    	return ServiceResult.succeed(searchService.search(code, value,user.getId()));
    }
