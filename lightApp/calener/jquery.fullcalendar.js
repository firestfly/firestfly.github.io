...
(function ($) {
    ...
    function init(target) {
        $(target).addClass('calendar').wrapInner(
            ...
            '<a class="calendar-prevyear fb ti-angle-double-left"></a>' +
            '<a class="calendar-year ml10 mr10"></a>' +
            '<a class="calendar-nextyear fb ti-angle-double-right mr15"></a>' +
            '<a class="calendar-prevmonth fb ti-angle-left"></a>' +
            '<a class="calendar-month ml10 mr10"></a>' +
            '<a class="calendar-nextmonth fb ti-angle-right"></a>' +
            '</div><div class="calendar-title"><span>Aprial 2010</span></div>' +
            '<div class="calendar-body fullcalendar-body">' +
            '<div class="calendar-menu">' +
            '<div class="calendar-menu-year-inner">' +
            '<span class="calendar-menu-prev fb ti-angle-left"></span>' +
            '<span><input class="calendar-menu-year" type="text"></input></span>' +
            '<span class="calendar-menu-next fb ti-angle-right"></span></div>' +
        ...
        $(target).find('.calendar-title span').click(function () {
    ...
    function showSelectMenus(target) {
        ...
        if ($(target).find('.calendar-menu-month-inner').is(':empty')) {
            ...
            $(target).find('.calendar-menu-month').click(function () {
                var menu = $(target).find('.calendar-menu');
    ...
    function show(target) {
        ...
        t.find('td').click(function () {
            ...
            //console.log(window.parent.$("#iframe").length)
            //动态添加div给予赋值
            ...
            if (opts.month != parts[1]) {
                ...
                opts.month = Number(parts[1]);
                show(target);
            }
            console.log(opts)
            alert(opts.year + "年" + opts.month + "月" + parts[2] + "日");
        });
