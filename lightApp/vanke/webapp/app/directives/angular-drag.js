...
!function (t) {
    ...
    i.prototype = {
        ...
        "undefined" == typeof n && (n = !!g), this.GPU = n, T.onstart = function (e) {
            ...
            var n = t.style;
            y.GPU ? (o = e.clientX - m, r = e.clientY - v) : (o = e.clientX - m + l, r = e.clientY - v + p), o = Math.max(a, Math.min(h, o)), r = Math.max(d, Math.min(f, r)), y.GPU ? n[g] = "translate3d(" + o + "px, " + r + "px, 0px)" : (n.left = o + "px", n.top = r + "px"), y.onmove(e)
        }, T.onend = function (e) {
            var n = t.style;
