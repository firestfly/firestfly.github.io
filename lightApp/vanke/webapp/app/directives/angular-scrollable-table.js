                ...
                link: function postLink(scope, elm, attrs, tableController) {
                    ...
                    function _init() {
                        ...
                        if (thInnerElms.find('.resize-rod').length == 0) {
                            ...
                            var resizeRod = $('<div class="resize-rod" ng-mousedown="resizing($event)"></div>');
