...
VkrmsApp.controller('ExperienceController', ['$scope', '$http', 'DataTableService', 'CommonService', function ($scope, $http, dataTableFactory, commonService) {
    ...
    $scope.$on('$viewContentLoaded', function () {
        var config = {
            "ajax": {
                "url": "department-fixed-post-collect",
                "type": "POST",
            ...
            "columnDefs": [
                ...
                },
                {
                    "targets": 4,
                    "data": null,
                    "defaultContent": '<a href="#" type="view">设置排班要求</a>'
                }
            ]
        };
    ...
    function bindLink() {
        ...
        areaTable.find('a').each(function (index, value) {
            ...
            //$(this).attr('href', hash + '0036036280');
        });
    }
