...
<head>
    ...
    <script type="text/javascript" src="${serverPath}/static/js/login.js"></script>
    <script type="text/javascript" src="${serverPath}/static/js/lib/CryptoJSv3.1.2/rollups/aes.js"></script>
    <link rel="stylesheet" href="${serverPath}/static/css/login.css"/>
</head>
<body>
...
<link rel="stylesheet" type="text/css" href="${serverPath}/static/css/bootstrap.min.css?v=${resourceVer}"/>
<link rel="stylesheet" type="text/css" href="${serverPath}/static/css/bootstrap-responsive.min.css?v=${resourceVer}"/>